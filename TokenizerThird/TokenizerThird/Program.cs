...
{
    //Hiii from Mutaz.
    //Hellooooooooooooooooooooooooo adel
    class Input
    {
        ...
        */
        ...
        public Input stepBack(int numOfSteps = 1)
        {
            ...
            {
                Console.WriteLine("Error, Cannot setp back further!");
            }
            return this;
        }
        ...
        //compare two characters and returns bool as the result.
        public bool Compare()
        {
            if (this.CurrentValue == this.peek())
            {
                return true;
            }
            else
    ...
    class Program
    {
        ...
        public class Tokenizer
        {
            ...
            public int currentPosition;
            public int lineNumber;
            public Tokenizer(string input, Tokenizable[] handlers) { }
            public Tokenizer(Input source, Tokenizable[] handlers) { }

            public Token tokenize() { return new Token(); }
        ...
        static void Main(string[] args)
        {
            ...
            Input input = new Input("Hello worlld!");
            Console.WriteLine(input.stepForward(4).peek());
